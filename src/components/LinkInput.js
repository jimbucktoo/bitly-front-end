        ...
        return (
            <div className="uiLinkInput LinkInput">
                <div class="uiInput input-group input-group-lg">
                    <input type="text" class="ellipsis uiInputBox form-control form-group" placeholder="Paste a link to shorten it" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" onChange={event => this.onInputChange(event.target.value)}></input>
